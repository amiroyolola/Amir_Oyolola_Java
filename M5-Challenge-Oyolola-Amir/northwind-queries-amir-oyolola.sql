...
/* What are the categories of the products in the database*/
SELECT *
FROM products
 
/*categories are: Camera,Laptop,Tablet,Phone
...
/*List all customers from zip coses that start wuth 55*/
SELECT *
FROM customers 
WHERE postal_code 
LIKE '55%'
...
/*List the first name, last name, and phone number from the 202 area code, ordered by last name, first name*/
SELECT 
	first_name, last_name, phone
FROM customers 
WHERE phone
