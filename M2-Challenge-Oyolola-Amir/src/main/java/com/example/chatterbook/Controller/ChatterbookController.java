...
import com.example.chatterbook.model.User;
import com.example.chatterbook.model.ChatterPost;
...
public class ChatterbookController {
    ...
    public List<ChatterPost> getUserByName(@PathVariable String name){
       for(User u : userList){
